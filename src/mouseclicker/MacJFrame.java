 ...
 * @author smyrnof
 */
public class MacJFrame extends MainJFrame {

    /**
     * Creates new form OSXJFrame
     */
    public MacJFrame() {
        initComponents();
    ...
    public void BtnHotkeySetMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if(cbHotkeyFirst.getSelectedItem().toString().equals(cbHotkeySecond.getSelectedItem().toString())){
            JOptionPane.showMessageDialog(MacJFrame.this,bundle.getString("SetHotkeyError"),bundle.getString("Error"),JOptionPane.ERROR_MESSAGE);
        }else{
            //TODO:
        }
    }     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MacJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
